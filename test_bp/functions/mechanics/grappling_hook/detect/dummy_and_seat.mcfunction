...
execute @e[type=test:grappling_hook_dummy] ~ ~ ~ scoreboard players operation @s CMP_Grapple_ID_1 = @s Grapple_Plyr_ID
execute @e[type=test:grappling_hook_seat] ~ ~ ~ scoreboard players operation @s CMP_Grapple_ID_2 = @s Grapple_Plyr_ID
scoreboard players operation @e[type=test:grappling_hook_dummy] CMP_Grapple_ID_1 -= @s Grapple_Plyr_ID
scoreboard players operation @e[type=test:grappling_hook_seat] CMP_Grapple_ID_2 -= @s Grapple_Plyr_ID
