...
execute @e[type=test:grappling_hook] ~ ~ ~ scoreboard players operation @s CMP_Grapple_ID_1 = @s Grapple_Plyr_ID
scoreboard players operation @e[type=test:grappling_hook] CMP_Grapple_ID_1 -= @s Grapple_Plyr_ID
