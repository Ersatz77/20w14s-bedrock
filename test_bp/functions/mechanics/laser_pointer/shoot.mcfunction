...
summon test:laser_pointer_rc ~ ~ ~
tp @e[type=test:laser_pointer_rc,r=1,c=1] ^ ^ ^-0.1 facing @s

# Start raycast
execute @e[type=test:laser_pointer_rc,r=1,c=1] ~ ~ ~ function mechanics/laser_pointer/setup_raycast
